...
class FaceAligner:
    def __init__(
        self,
        allow_low_threshold=True,
        fallback_centercrop=True,
        crop_size=(112, 112),
        device="cuda:0",
    ):
        ...
        self.mtcnn_model = mtcnn.MTCNN(
            device=device, crop_size=crop_size, low_threshold=allow_low_threshold
        )
    ...
    def center_crop(self, rgb_img: Image.Image) -> Image.Image:
        ...
        assert self.crop_size[0] == self.crop_size[1], (
            "non square center crop not implemented yet"
        )
