...
class Backbone(Module):
    ...
    def forward(self, x, return_intermediate=False, return_style=[]):
        ...
        return_style_mapping = {3: 15, 5: 45}
        return_style = [return_style_mapping[s] for s in return_style]
...
class Depth_Wise(Module):
    ...
    def __init__(
        ...
        self.conv_dw = Conv_block(
            groups, groups, kernel, stride, padding, groups=groups
        )
...
class Residual(Module):
    ...
    def __init__(
        self, channel, num_block, groups, kernel=(3, 3), stride=(1, 1), padding=(1, 1)
    ):
